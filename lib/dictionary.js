...
const DICTIONARY = {
  ...
  'tartar': 'TARTAR',
  // 'tartar sauce' deliberately NOT a multi-word phrase — the actual
  // Notion slug is "Tar-Tar" (no SAUCE in slug), so splitting the
  // query into [TARTAR, SAUCE] and letting firstMatchPosition pick
  // the Tar-Tar recipe works better than a TARTAR-SAUCE composite
  // that no slug actually contains.
  'truffle': 'TRUFFLE',

...
function buildRestaurantFooter(restaurant) {
...
function formatRecipe(recipe, options = {}) {
  if (isEmpty(recipe)) return buildEmpty(recipe) + buildRestaurantFooter(options.restaurant);
  ...
  const footer = buildRestaurantFooter(options.restaurant);

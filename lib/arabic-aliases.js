...
const ARABIC_ALIASES = {
  ...
  // ── Common kitchen-typed transliterations seen in user queries ──────
  // (added after observing real "not found" entries in bot logs)
  'ترافل':      'TRUFFLE',       // alt spelling of ترفل
  'بافلو':      'BUFFALO',
  'بوفالو':     'BUFFALO',
  'بفالو':      'BUFFALO',
  'جزر':        'CARROT',
  ...
  'جريتان':     'GRATIN',
  'جراتان':     'GRATIN',
  'اتشكن':      'CHICKEN',         // common dialect typo of الدجاج
  'تشكن':       'CHICKEN',
  'الاكيف':     'KYIV',
  'اكيف':       'KYIV',
  'كييف':       'KYIV',
